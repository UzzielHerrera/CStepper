...
#if IDENTIFIER == 0xC1
    #define DEFAULT_PARAMS_ZERO 32.96
    #define DEFAULT_PARAMS_SETPOINT 89.43
    #define DEFAULT_PARAMS_MINIMUM_ANGLE 0.0
    #define DEFAULT_PARAMS_MAXIMUM_ANGLE 0.0
#elif IDENTIFIER == 0xC2
    #define DEFAULT_PARAMS_ZERO 23.47
    #define DEFAULT_PARAMS_SETPOINT 70.86
    #define DEFAULT_PARAMS_MINIMUM_ANGLE 0.0
    #define DEFAULT_PARAMS_MAXIMUM_ANGLE 0.0
#elif IDENTIFIER == 0xC3
    #define DEFAULT_PARAMS_ZERO 12.74
    #define DEFAULT_PARAMS_SETPOINT 63.60
    #define DEFAULT_PARAMS_MINIMUM_ANGLE -432.79
    #define DEFAULT_PARAMS_MAXIMUM_ANGLE 121.44
#else 
